...
namespace Repository.Data
{
    public class Episodes
    {
        ...
        public async Task<Episode> getEpisode(string idEpisode)
        {
            try
            {
                HttpClient client = Connection.Instance._httpClient;
        ...
        public async Task<List<Episode>> getMultipleEpisodes(string[] list)
        {
            List<Episode> episodes = new List<Episode>();
        ...
        public async Task<List<Episode>> filterEpisodes(string query)
        {
            List<Episode> episodes = new List<Episode>();
